...
<Variable name="keycolor" description="Main Color" type="color" default="#f67938" value="#eeeeee"/>
<Variable name="body.background" description="Body Background Color" type="color" default="#ffffff" value="#EEEEEE"/>
...
<Variable name="body.link.color" description="Link Color" type="color" default="$(keycolor)" value="#38f67b"/>
<Variable name="body.hover.color" description="Link Hover" type="color" default="#f46013" value="#000000"/>
...
<Variable name="logo.width" description="Logo Max Width" type="length" default="200px" min="50px" max="500px" value="192px"/>
<Variable name="logo.width.mobile" description="Logo Max Width (mobile)" type="length" default="150px" min="50px" max="500px" value="238px"/>
</Group>
...
<b:section class='container position-relative px-3 flex-nowrap' id='header-main' maxwidgets='3' showaddelement='no'>
  ...
  <b:widget id='LinkList11' locked='true' title='Menu' type='LinkList' version='2' visible='true'>
    <b:widget-settings>
      ...
      <b:widget-setting name='link-1'>https://ppibazarbd.blogspot.com/</b:widget-setting>
    ...
    <b:section class='row row-cols-sm-2 row-cols-lg-4 justify-content-evenly' id='footer-widget' showaddelement='yes'>
      ...
      <b:widget id='LinkList13' locked='false' title='CONTACT US' type='LinkList' version='2' visible='true'>
        <b:widget-settings>
          ...
          <b:widget-setting name='link-1'>#</b:widget-setting>
          <b:widget-setting name='text-0'>Phone: +8801739443802</b:widget-setting>
          <b:widget-setting name='link-0'>#</b:widget-setting>
        </b:widget-settings>
        <b:includable id='main'>
...
<b:loop index='i' values='data:post.labels where (l =&gt; l.name contains &quot;#&quot;)' var='label'>
<b:class expr:cond='data:i == 0' name='mb-4'/>
<a class='btn jt-btn-light rounded-pill me-2 mb-2 px-3' expr:href='data:label.url.canonical + &quot;?max-results=10&quot;' rel='tag'><data:label.name/></a>
</b:loop>
</div>
